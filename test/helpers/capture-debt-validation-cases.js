const SCHEME_ERROR = 'The scheme must be one of the following: SFI22, SFI Pilot, Lump Sums, Annual Health and Welfare Review, CS, BPS, SFI23, Delinked, Expanded SFI Offer, Combined Offer Higher Tier Revenue, Combined Offer Higher Tier Capital, Farm Payments Technical Test, Woodland Management Plan, SFI26'
...
const invalidNetTests = [
  ...
  { description: 'negative net', field: () => ({ net: -100.2 }), error: 'The net value must be positive' },
